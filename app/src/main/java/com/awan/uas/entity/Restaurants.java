...
public class Restaurants {
    ...
    public class Restaurant implements Serializable{
        ...
        public int getRange(){return price_range;}
        public void setRange(int price_range){this.price_range=price_range;}
        public String getCurrency() {
            return currency;
        }
        public int Online(){return has_online_delivery;}
        public void setHas_online_delivery(int has_online_delivery){this.has_online_delivery=has_online_delivery;}
